...
@section('content')
<div class="container-fluid text-center" style="height; 94vh">
            ...
            <div class="w-50 m-auto">
                ...
                <div class="border border-dark p-2 mb-1">
                    ...
                    <div class="d-flex flex-row align-items-center justify-content-between border border-dark p-2 mb-2">
                        ...
                        <a href="{{ route('user.download', ['token' => $music->purchase_token->token, 'id' => $music->music->id]) }}" type="button" class="btn btn-primary">Download</a>
                    </div>
                    @endforeach
                </div>
                @endforeach
